function restud
    switch $argv[1]
        ...
        case _create_cookie
            ...
            jq -n --arg value $value --arg date $expr_dt '{"name":"session", "value":$value, "exp_date":$date}' > ~/.config/restud/restud-cookie.json
        case _commit
        ...
        case _community_accept 
            ...
            set url (tail -n1 .accept_request | string replace \" "" -a)
